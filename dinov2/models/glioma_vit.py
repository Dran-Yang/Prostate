...
class GliomaDinoViT(DinoVisionTransformer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.mri_sequences = list(mri_sequences or self.mri_sequences_default)
        self.mri_seq_embed = nn.Embedding(len(self.mri_sequences), self.embed_dim)
        self.register_buffer(
            "mri_seq_idx_map",
            torch.arange(len(self.mri_sequences)),
            persistent=False,
        )
